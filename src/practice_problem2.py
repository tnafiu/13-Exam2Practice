...
def run_test_practice_problem2a():
    ...
    actual = practice_problem2a([2, 4, 6, 8, 10], 4)
    print('Expected: ', expected)
    print('Actual: ', actual)

    # Test 2:
    expected = [3, 4, 5, 6, 7, 8]
    actual = practice_problem2a([1, 2, 3, 4, 5, 6], 2)
    print('Expected: ', expected)
    print('Actual: ', actual)

    # Test 3:
    expected = [6, 9, 12, 15, 18]
    actual = practice_problem2a([3, 6, 9, 12, 15], 3)
    print('Expected: ', expected)
    print('Actual: ', actual)

    # Test 4:
    expected = [5, 10, 15, 20, 25, 30, 35]
    actual = practice_problem2a([0, 5, 10, 15, 20 ,25, 30], 5)
    print('Expected: ', expected)
    print('Actual: ', actual)
